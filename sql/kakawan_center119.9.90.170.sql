...
Source Server         : 119.9.90.170
Source Server Version : 50626
Source Host           : 119.9.90.170:3306
...
-- ----------------------------
-- Table structure for c_total_report_config_copy
-- ----------------------------
DROP TABLE IF EXISTS `c_total_report_config_copy`;
CREATE TABLE `c_total_report_config_copy` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `source_table_name` varchar(50) DEFAULT NULL,
  `select_bet_table_sql` mediumtext,
  `temp_table_name` varchar(50) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=19127969 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=2540 DEFAULT CHARSET=utf8 COMMENT='BBIN体育，3D，机率注单都放在此表';
...
) ENGINE=InnoDB AUTO_INCREMENT=4676809 DEFAULT CHARSET=utf8 COMMENT='BBIN体育，3D，机率注单都放在此表';
...
CREATE TABLE `ds_bbin_live` (
  ...
  PRIMARY KEY (`id`),
  KEY `wagers_id_index` (`wagers_id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=11572557 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ds_bbin_sport` (
  ...
  KEY `wagers_id_index` (`wagers_id`) USING BTREE,
  KEY `bbin_game_kind_index` (`bbin_game_kind`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=35901 DEFAULT CHARSET=utf8 COMMENT='BBIN体育，3D，机率注单都放在此表';
...
) ENGINE=InnoDB AUTO_INCREMENT=7925909 DEFAULT CHARSET=utf8 COMMENT='DS彩票';
...
) ENGINE=InnoDB AUTO_INCREMENT=10165067 DEFAULT CHARSET=utf8 COMMENT='DS彩票';
...
) ENGINE=InnoDB AUTO_INCREMENT=15652921 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ds_fenfen_saibao` (
  ...
  `create_time` datetime DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=30357 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ds_jingdian_lottery` (
  ...
  `time_draw` varchar(50) DEFAULT NULL,
  `time_in` varchar(50) DEFAULT NULL,
  `time_add` varchar(50) NOT NULL,
  `time_jiesuan` varchar(50) DEFAULT NULL,
  `time_pay` varchar(50) DEFAULT NULL,
  `is_cancel` bit(1) NOT NULL,
  `cancel_content` varchar(50) DEFAULT NULL,
...
) ENGINE=InnoDB AUTO_INCREMENT=14793491 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=20893 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=7535373 DEFAULT CHARSET=utf8 COMMENT='DS视讯表';
...
) ENGINE=InnoDB AUTO_INCREMENT=555485 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=72404858 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ds_lotto_bet` (
  ...
  KEY `username` (`username`) USING BTREE,
  KEY `win_loss_type` (`win_loss_type`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1831935 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ds_m8_sport` (
  ...
  KEY `site_id` (`site_id`) USING BTREE,
  KEY `flag` (`flag`)
) ENGINE=InnoDB AUTO_INCREMENT=65199 DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=1219849 DEFAULT CHARSET=utf8 COMMENT='会员代理信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=2316237 DEFAULT CHARSET=utf8;
...
CREATE TABLE `ds_report` (
  ...
  KEY `superior` (`superior`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=1837297 DEFAULT CHARSET=utf8 COMMENT='注单统计报表';
...
CREATE TABLE `lottery_info` (
  `user` varchar(50) NOT NULL COMMENT '管理账户',
...
CREATE TABLE `temp_audit_total` (
  ...
  KEY `username` (`username`)
) ENGINE=InnoDB AUTO_INCREMENT=146330487 DEFAULT CHARSET=utf8;
...
-- ----------------------------
-- Table structure for temp_jingdian
-- ----------------------------
DROP TABLE IF EXISTS `temp_jingdian`;
CREATE TABLE `temp_jingdian` (
  `id` int(11) NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
) ENGINE=InnoDB AUTO_INCREMENT=5057937 DEFAULT CHARSET=utf8;
